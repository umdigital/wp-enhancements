...
class WPEnhancements
{
    static public function init()
    {
        ...
        include WPENHANCEMENTS_PATH .'includes'. DIRECTORY_SEPARATOR .'ssl.php';
        ...
        add_action( 'admin_menu', function(){
            add_options_page(
                ...
                'um_wpe',
                function(){
                    include WPENHANCEMENTS_PATH .'templates'. DIRECTORY_SEPARATOR .'admin.tpl';
                }
            );
        });
    }
